      ...
      <div className="overflow-hidden rounded-3xl border border-stone-200 bg-white shadow-xl p-8">
        ...
        <div className="grid gap-6 sm:grid-cols-2 text-xs leading-7 text-stone-700">
          ...
          <div className="rounded-2xl bg-stone-50 p-4">
            ...
            <p><strong>روش ارسال:</strong> {order.shippingProvider === "tipax" || !order.shippingProvider || order.shippingProvider === "postex" ? "ارسال سریع تیپاکس (Tipax)" : order.shippingProvider === "post" ? "پست پیشتاز" : "پیک"}</p>
          </div>
        </div>
